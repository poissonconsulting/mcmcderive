...
The `mcmc_derive()` function accepts (and returns) `mcmc.list` and [`mcmcr`](https://github.com/poissonconsulting/mcmcr) objects. 
All other MCMC objects are first converted into `mcmcr` objects.
